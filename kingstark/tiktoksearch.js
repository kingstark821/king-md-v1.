...
const OUTER_HEADER_TITLE = toFullWidth("KING-MD-V1");
const OUTER_FOOTER_TEXT = "| POWERED BY KING STARK";
const CARD_FOOTER_TEXT = "KING-MD-V1";
...
module.exports = {
    ...
    handler: async ({ socket, msg, sender, args, reply }) => {
        ...
        if (!searchQuery) {
            return reply(`${EMOJI_ERROR} *Usage:* \`.ts king\` හෝ \`.ts trending\``);
        }
