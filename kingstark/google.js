...
module.exports = {
    ...
    handler: async ({ socket, msg, sender, args, reply }) => {
        try {
            ...
            console.log("[KING-MD GOOGLE] Fetching search results...");
            ...
            if (response.data && response.data.success && response.data.result) {
                ...
                console.log("[KING-MD GOOGLE] Fetching live screenshot from Bing visual...");
                try {
                    ...
                    console.error("[KING-MD GOOGLE] Screenshot API 1 Failed. Trying Fallback...", ssError.message);
                    ...
                    try {
                        ...
                        console.error("[KING-MD GOOGLE] Fallback failed too:", fallbackError.message);
                        await socket.sendMessage(sender, { react: { text: "❌", key: msg.key } });
                    }
                }
            ...
            console.error("[KING-MD GOOGLE] Main Error:", error.message);
            await socket.sendMessage(sender, { react: { text: "❌", key: msg.key } });
